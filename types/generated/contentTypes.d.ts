...
export interface ApiFeaturedDoctorFeaturedDoctor extends Schema.CollectionType {
  collectionName: 'featured_doctors';
  info: {
    displayName: 'Featured Doctor';
    pluralName: 'featured-doctors';
    singularName: 'featured-doctor';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::featured-doctor.featured-doctor',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFeedbackTemplateFeedbackTemplate
  extends Schema.CollectionType {
  collectionName: 'feedback_templates';
  info: {
    displayName: 'Feedback Template';
    pluralName: 'feedback-templates';
    singularName: 'feedback-template';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiInsurancePlanInsurancePlan extends Schema.CollectionType {
  collectionName: 'insurance_plans';
  info: {
    description: 'Insurance plans section with provider information';
...
export interface ApiPromoBannerPromoBanner extends Schema.CollectionType {
...
export interface ApiTopBrandTopBrand extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tagline: Attribute.String;
    title: Attribute.String & Attribute.Required;
    type: Attribute.Enumeration<['Clinic', 'Hospital', 'Pharmacy']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::top-brand.top-brand',
      'oneToOne',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::featured-doctor.featured-doctor': ApiFeaturedDoctorFeaturedDoctor;
      'api::feedback-template.feedback-template': ApiFeedbackTemplateFeedbackTemplate;
